...
function Main() {
  ...
  return (
    <>
      ...
      <i onClick={prev} className="bi bi-chevron-compact-left"></i>
        <img
            src={images[curentIndex]} alt={`Slide ${curentIndex+1}`}
        ></img>
        <i onClick={next} className="bi bi-chevron-compact-right"></i>
      </div>
      <div id='grid_wrapper'>
        <div className='grid1'>
        ...
        <div className='grid1'>
        <h4>Starting  <i className="bi bi-currency-rupee"></i>149 | Headphones</h4>
            <div onClick={handleExploreClick2} className='inner_grid'><figure>
                <img src={g31} alt='boat' loading='lazy'></img>
                <figcaption>Starting  <i className="bi bi-currency-rupee"></i>249 | boAt</figcaption>
            </figure>
            <figure>
                <img src={g32} alt='boult' loading='lazy'></img>
                <figcaption>Starting  <i className="bi bi-currency-rupee"></i>349 | boult</figcaption>
            </figure>
            <figure>
                <img src={g33} alt='noise' loading='lazy'></img>
                <figcaption>Starting  <i className="bi bi-currency-rupee"></i>639 | Noise</figcaption>
            </figure>
            <figure>
                <img src={g34} alt='zebronics' loading='lazy'></img>
                <figcaption>Starting  <i className="bi bi-currency-rupee"></i>137 | Zebronics</figcaption>
            </figure>
        </div>
        ...
        <div className='grid1'>
        <h4>Starting  <i className="bi bi-currency-rupee"></i>199 | Amazon Brands & more</h4>
      ...
      <div onClick={handleExploreClick9} id='flex_wrapper'>
        ...
        <i id='left' onClick={previmg1} className="bi bi-chevron-compact-left"></i>
            <img src={imgarr1[imgs1]} alt='fashion' loading='lazy'></img>
        <i id='right' onClick={nextimg1} className="bi bi-chevron-compact-right"></i>
      </div>
      <div id='grid_wrapper'>
        <div  className='grid1'>
        <h4>Under <i className="bi bi-currency-rupee"></i>499 | Pocket-friendly fashion</h4>
      ...
      <div id='flex_wrapper'>
        ...
        <i id='left' onClick={previmg2} className="bi bi-chevron-compact-left"></i>
            <img onClick={handleExploreClick10} src={imgarr2[imgs2]} alt='fashion' loading='lazy'></img>
        <i id='right' onClick={nextimg2} className="bi bi-chevron-compact-right"></i>
      </div>
      <div id='grid_wrapper'>
      <div className='grid1'>
        <h4>Starting <i className="bi bi-currency-rupee"></i>99 | Start your fitness journey</h4>
        ...
        <div className='grid1'>
        <h4>No cost EMI up to 24 months | Starting <i className="bi bi-currency-rupee"></i>2,233</h4>
        <div id='maincont'>
            <figure>
      ...
      <div id='flex_wrapper'>
        ...
        <i id='left' onClick={previmg3} className="bi bi-chevron-compact-left"></i>
            <img onClick={handleExploreClick11} src={imgarr3[imgs3]} alt='fashion' loading='lazy'></img>
        <i id='right' onClick={nextimg3} className="bi bi-chevron-compact-right"></i>
      </div>
      <div id='flex_wrapper'>
        <h3 onClick={handleExploreClick12}>Best deals curated from stores nearby<span>See all offers</span></h3>
        <i id='left' onClick={previmg4} className="bi bi-chevron-compact-left"></i>
            <img onClick={handleExploreClick12} src={imgarr4[imgs4]} alt='fashion' loading='lazy'></img>
        <i id='right' onClick={nextimg4} className="bi bi-chevron-compact-right"></i>
      </div>
      <div id='top'>
